import { MultistepFlowPageObject } from '../multistep-flow/page-objects';
 ...
 *   - @param {type} name
 */
export const RoutedMultistepFlowPageObject = MultistepFlowPageObject.extend('routed-multistep-flow')
