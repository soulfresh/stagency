 ...
 * description
 *
 * __Selector__: `fieldset`
 *
 * __Locator__: Text content of the legend element.
 *
 ...
 *   - @param {type} name
 */
export const FieldsetPO = HTMLPageObject.extend('fieldset')
  ...
  .locator((el: HTMLElement) => elementText( el.querySelector('legend') ))
