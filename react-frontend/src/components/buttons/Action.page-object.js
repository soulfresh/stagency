import { ButtonPageObject, elementText, getLabel } from '~/test';
 ...
 *   - @param {type} name
 */
export const ActionPageObject = ButtonPageObject.extend('action')
  ...
  .filters({
    label: getLabel,
    // The placeholder text is actually just the text content of the
    // button styled differently.
    placeholder: el => elementText(el),
    hidden: el => el.getAttribute('aria-hidden') === 'true',
  })
